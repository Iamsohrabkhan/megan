...
const Hero=() => {
    return (
        <>       
          <section className="min-h-screen container mx-auto flex flex-col items-center ">
            <h1 className="bg-[#7C96A6] text-sm md:text-base  w-fit text-muted px-2 py-1 rounded-lg">Welcome to Megan Lacefield&apos;s Corner</h1>
