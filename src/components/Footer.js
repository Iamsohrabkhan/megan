...
return (
    <li>
        <Link href={link} className="duration-200 hover:text-[#7C96A6] ">
            {text}
        </Link>
    </li>
)
...
return (
    <div className="space-y-6">
        <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Links</h1>
...
return (
    <footer className="mt-4">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
            <div className="w-full flex flex-col md:flex-row gap-4 items-center sm:justify-between py-3 border-t ">
